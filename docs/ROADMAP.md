...
1. Harden the vertical slice: spatial keyboard navigation, focus trapping, IndexedDB slots,
   save import/export, card-per-turn enforcement, complete tutorial gates, and service-worker tests.
   Complete native-speaker editorial review for formal Arabic and Tunisian historical transcriptions.
2. Expand the compact quick map to 20–35 readable territories and balance through AI simulations.
3. Add polished original pixel sprites, animation atlas, and original faction music loops.
